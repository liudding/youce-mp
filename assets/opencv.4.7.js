var cv = (function () {
    ...
    return (
        function (cv) {
            ...
            var proxiedFunctionTable = [null, _atexit, _emscripten_set_canvas_element_size_main_thread, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write, _sysconf];
            ...
            var __emscripten_main_thread_futex = Module["__emscripten_main_thread_futex"] = 775468;
